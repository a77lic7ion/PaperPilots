...
if (content.includes(find6)) {
    content = content.replace(find6, replace6);
...
if (content.includes(find7)) {
    content = content.replace(find7, replace7);
...
if (content.includes(find8_1)) {
    content = content.replace(find8_1, replace8_1);
...
if (content.includes(find8_2)) {
    content = content.replace(find8_2, replace8_2);
...
const find9_1 = `        function setPlayerName(val) {
...
if (content.includes(find9_2)) {
    content = content.replace(find9_2, replace9_2);
